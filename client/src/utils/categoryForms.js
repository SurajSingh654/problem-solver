  ...
  return (
    ...
    >
      <div className="flex items-start gap-3 mb-4">
        <div
          className="w-8 h-8 rounded-lg bg-brand-400/15 flex items-center
    ...
    <div className="p-6 max-w-[800px] mx-auto">
      ...
      <div className="bg-surface-1 border border-border-default rounded-2xl p-5 mb-6">
        <div className="flex items-center gap-2 mb-2 flex-wrap">
          ...
          {problem.source &&
            !["MANUAL", "AI_GENERATED"].includes(problem.source) && (
              <span
                className="text-[10px] font-bold text-text-disabled bg-surface-3
        ...
        >
          ...
          <div>
            ...
            <p className="text-xs text-text-tertiary leading-relaxed">
              Click the link above to solve the problem on{" "}
              {problem.source || "the external site"}. Once done, come back and
              paste your code below. AI will analyze your solution's complexity,
              quality, and suggest optimizations.
            </p>
          </div>
        </motion.div>
      )}
      ...
      <div className="space-y-5">
        ...
        {(category === "CODING" || category === "SQL" || hasExternalLink) && (
          ...
          >
            ...
            <CodeEditor
              ...
              placeholder={
                formConfig.solutionTabConfig?.codePlaceholder ||
                "// Paste your solution here..."
              }
              minHeight="200px"
            />
            <p className="text-[10px] text-text-disabled mt-2">
              🤖 AI will automatically analyze time/space complexity and suggest
              optimizations
            </p>
          </FormSection>
        )}
        ...
        <FormSection
          icon={
            category === "BEHAVIORAL" ? "🎯" : category === "HR" ? "💬" : "📝"
          }
          title={
            category === "BEHAVIORAL"
              ? formConfig.actionField?.label || "Your Response"
              : category === "HR"
                ? "Your Answer"
          ...
          hint={
            hasExternalLink
              ...
              : category === "BEHAVIORAL"
                ? formConfig.actionField?.hint ||
                  "Use STAR format — be specific about YOUR actions."
                : category === "SYSTEM_DESIGN"
          ...
          <RichTextEditor
            ...
            placeholder={
              hasExternalLink
                ...
                : fields.patternReasoning?.placeholder ||
                  "Write your approach here..."
            }
            minHeight={
              category === "CODING" && hasExternalLink ? "120px" : "180px"
            }
          />
        </FormSection>
        ...
        {fields.simpleExplanation?.show && (
          ...
          >
            <RichTextEditor
              ...
              placeholder={
                fields.simpleExplanation.placeholder ||
        ...
        {fields.challenges?.show && (
          <FormSection
            icon="🌍"
            title={
              fields.challenges.label || "Challenges & Real-World Connection"
            }
          >
            <RichTextEditor
              ...
              placeholder={
                fields.challenges.placeholder ||
                "What was challenging? How does this connect to real-world software?"
              }
              minHeight="80px"
            />
          </FormSection>
          ...
          >
            <div className="space-y-2.5">
              {problem.followUpQuestions.map((fq, i) => (
                ...
                >
                  <span
                    className="flex-shrink-0 w-6 h-6 rounded-full bg-surface-3
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {fq.hint && (
                      <details className="mt-1.5">
                        <summary
                          className="text-[10px] text-brand-300 cursor-pointer
                                              hover:text-brand-200 transition-colors w-fit"
                        >
                          💡 Show hint
                        </summary>
                        <p
                          className="text-[10px] text-text-tertiary mt-1 bg-surface-3
      ...
      {/* Submit bar */}
      <div
        className="sticky bottom-0 bg-surface-0/90 backdrop-blur-lg border-t
