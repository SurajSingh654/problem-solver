...
export async function register(req, res) {
  ...
  if (existingUsername) {
    return errorResponse(res, 'Username is already taken', 409, 'USERNAME_TAKEN')
  }
  ...
  if (existingEmail) {
    return errorResponse(res, 'An account with this email already exists', 409, 'EMAIL_TAKEN')
  }
